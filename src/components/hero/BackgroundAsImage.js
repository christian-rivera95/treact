...
export default () => {
  const navLinks = [
    <NavLinks key={1}>
      ...
      <NavLink href="#OurTeam">Nuestro Equipo</NavLink>
      ...
      <HeroContainer>
        ...
        <TwoColumn>
          <LeftColumn>
            ...
            <Heading>
              <SlantedBackground style={{ color: "#0e134a", fontSize: "37px" }}>
                Contrata al mejor equipo
              </SlantedBackground>
              <br />
              <SlantedBackground style={{ color: "#d8c614", fontSize: "37px" }}>
