...
export default ({
  ...
  heading = (
    <>
      Contamos con el equipo de evaluación de puestos más{" "}
  ...
  const defaultFeatures = [
    {
      ...
      description:
        "Contamos con los mejores profesionales de evaluación de puestos de todo el mundo para trabajar con usted.",
    },
    {
      Icon: MoneyIcon,
      title: "Asequible",
      description:
        "Prometemos ofrecerle la mejor tarifa posible, a la par del estándar de la industria.",
    },
  ];
